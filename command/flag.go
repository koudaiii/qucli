...
func FlagInit(args []string) error {
	...
	flags.StringVar(&ref, "ref", "", "An optional regular expression for matching the git branch or tag git ref. If left blank, the notification will fire for all builds.(refs/heads/somebranch)|(refs/tags/sometag)")
